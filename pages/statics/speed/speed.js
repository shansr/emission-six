...
Page({
    ...
    wx.request({
      ...
      success: function (e) {
        ...
        if (e.data.code == 1) {
          ...
          // wx.request({
          //   url: 'https://wit.weichai.com/statics/speed/' + e.data.message[0].vin + '/6',
          //   success: function (e) {
          //     console.log(e)
          //     var option = createOption(plateNo + '日均车速(Km/h)', e.data.msg)
          //     thisChart.setOption(option, true)
          //   }
          // })
          thisCtx.setData({
  ...
  vehicleItemClick(e) {
    ...
    wx.request({
      url: 'https://wit.weichai.com/statics/speed/' + e.currentTarget.dataset.vehicle.vin + '/6',
      success: function (e) {
        //console.log(e)
        wx.hideLoading()
        if (e.data.code == 1) {
